...
const (
	...
	// StaticCommonEncryption The Asset is encrypted with static Common Encryption.
	StaticCommonEncryption AssetStorageEncryptionFormat = "StaticCommonEncryption"
	// StaticEnvelopeEncryption The Asset is encrypted with static envelope encryption.
	StaticEnvelopeEncryption AssetStorageEncryptionFormat = "StaticEnvelopeEncryption"
)
...
func PossibleAssetStorageEncryptionFormatValues() []AssetStorageEncryptionFormat {
	return []AssetStorageEncryptionFormat{MediaStorageClientEncryption, None, StaticCommonEncryption, StaticEnvelopeEncryption}
}
...
type AssetProperties struct {
	...
	// StorageAccountID - The ARM resource ID of the Azure Storage account containing the Asset.
	StorageAccountID *string `json:"storageAccountId,omitempty"`
	// StorageEncryptionFormat - The Asset encryption format. One of None, MediaStorageEncryption, StaticCommonEncryption or StaticEnvelopeEncryption. Possible values include: 'None', 'MediaStorageClientEncryption', 'StaticCommonEncryption', 'StaticEnvelopeEncryption'
	StorageEncryptionFormat AssetStorageEncryptionFormat `json:"storageEncryptionFormat,omitempty"`
	// StorageEncryptionKey - The Base64 encoded key for the Asset storage encryption.
...
// StreamingLocatorUserDefinedContentKey describes the properties of a user-defined content key in the Streaming
// Locator
